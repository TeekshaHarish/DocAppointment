...
const { getDoctorInfoContoller, updateDoctorProfilecController, getDoctorByIdContoller, getDoctorAppointmentsController, markAppointmentCompletedController, deleteAppointmentController } = require("../controllers/DoctorCtrl");
